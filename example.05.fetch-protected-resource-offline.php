...
/**
 * Example of how to fetch a protected resource offline for a user previously authenticated with OpenID Connect.
 *
 * Given an WebID URL, this example demonstrates how to fetch Tokens
 * (Code, Refresh Access) needed to access a protected resource offline
 */
